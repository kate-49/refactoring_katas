...
func Test_UpdateDexterityVest(t *testing.T) {
	var items = []*gildedrose.Item{
		{"+5 Dexterity Vest", 10, 10},
		{"+5 Dexterity Vest", 10, 20},
		{"+5 Dexterity Vest", 12, 10},
		{"+5 Dexterity Vest", 12, 20},
		{"+5 Dexterity Vest", 4, 10},
		{"+5 Dexterity Vest", 4, 20},
		{"+5 Dexterity Vest", 4, 30},
		{"+5 Dexterity Vest", 4, 40},
	...
	EqualValues(t, items[0].Name, items[0].Quality, 9)
	EqualValues(t, items[1].Name, items[1].Quality, 19)
	EqualValues(t, items[2].Name, items[2].Quality, 9)
	EqualValues(t, items[3].Name, items[3].Quality, 19)
	EqualValues(t, items[4].Name, items[4].Quality, 9)
	EqualValues(t, items[5].Name, items[5].Quality, 19)
	EqualValues(t, items[6].Name, items[3].Quality, 19)
	EqualValues(t, items[7].Name, items[4].Quality, 9)
	EqualValues(t, items[8].Name, items[5].Quality, 19)
	EqualValues(t, items[9].Name, items[6].Quality, 29)
	EqualValues(t, items[10].Name, items[7].Quality, 39)
	EqualValues(t, items[11].Name, items[8].Quality, 49)
	EqualValues(t, items[12].Name, items[9].Quality, 0)
	EqualValues(t, items[13].Name, items[10].Quality, 0)
}
...
func Test_UpdateAgedBrie(t *testing.T) {
	...
	EqualValues(t, items[2].Name, items[2].Quality, 21)
...
func Test_UpdateElixirOfTheMongoose(t *testing.T) {
	var items = []*gildedrose.Item{
		...
		{"Elixir of the Mongoose", 12, 10},
		{"Elixir of the Mongoose", 12, 20},
	...
	EqualValues(t, items[3].Name, items[3].Quality, 9)
	EqualValues(t, items[4].Name, items[4].Quality, 19)
